...
<div style="display:flex">
     <div style="flex:1;padding-left:160px;">
          <img src="./images/test_ROC.png" width="100%" height="100%">
     </div>
     <div style="flex:1;padding-right:220px;">
          <img src="./images/test_PR.png" width="100%" height="100%">
     </div>
</div>
...
## Installation
Download _tfdrive_files.7z_ from [here](https://drive.google.com/file/d/1yIZBw4H31s3XNoZfrsoFgTcci03nbBkX/view?usp=sharing) (174 MB) and unpack _tfdrive.py_ and the _data_ folder to your project folder.
